...
generate_tree_rec(bin_tree_rec,root=Root,height=Height,left_leaf=left_leaf_func,right_leaf=right_leaf_func)
print(bin_tree_rec)

generate_tree(bin_tree,root= Root,height=Height,left_leaf=left_leaf_func,right_leaf=right_leaf_func)
print(bin_tree)